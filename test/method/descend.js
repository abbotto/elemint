describe('$.descend', () => {
	const html = '<section><span><div class="item"><div class="sub-item-1"></div></div></span></section>'
	...
	it('should throw an error if the elements selected ancestors aren\'t found via the "elemint" object', () => {
		const newHtml = html + '<section><span><div class="item"><div class="sub-item-2"></div></div></span></section>';
	...
	it('should throw an error if the elements selected ancestors aren\'t found at the specified depth via the "elemint" object', () => {
		const newHtmlA = '<div class="item A1"><div class="item A2"><div class="item A3"><div class="item A4"></div></div></div></div>';
		const newHtmlB = '<div class="item B1"><div class="item B2"><div class="item B3"><div class="item B4"></div></div></div></div>';
